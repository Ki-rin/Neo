...
if __name__ ==  '__main__':
    ...
    GPT_FINE_TUNED_FILE = "fine_tuned_models/gpt-neo-125M-ML-ArXiv-Papers-02"
    ...
    current_dataset = load_from_disk('./datasets/Cornell-University/arxiv/trimmed_arxiv_docs.json/test')
